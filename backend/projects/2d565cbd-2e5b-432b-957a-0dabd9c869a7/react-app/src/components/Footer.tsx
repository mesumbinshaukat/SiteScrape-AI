Here's the React functional component code written in TypeScript. The original HTML, CSS, and JS have been converted according to your requirements. Inline styles are used for simplicity, and media queries can be added as necessary for responsive design.
...
const FooterInfo = styled.div`
  /* Add styles similar to class Footer_info__pUNzI */
`;

const FooterTop = styled.div`
  /* Add styles similar to class Footer_top__58Lzg */
`;

const Footer: React.FC = () => {
  // Define any state or effect hooks here if necessary
  // const [someState, setSomeState] = useState(initialValue);
  
  // Use useEffect for any side effects if necessary
  // useEffect(() => {
  //   // Side effect logic
  // }, []);
...
### Notes:
- I used `styled-components` for the styling. Define the necessary styles based on the original CSS classes if needed.
- You can expand the state and effect hooks if you have any interactive behaviors from the original JS.
- Ensure you have `styled-components` and `framer-motion` installed in your project to use the above code.