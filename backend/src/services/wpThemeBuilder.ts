...
`;
  ...
  private generateDemoContent(): string {
    ...
    const safeThemeName = this.themeName.replace(/[^a-zA-Z0-9\s]/g, '');
...
<channel>
    ...
    <wp:author>
        ...
        <wp:author_display_name><![CDATA[SiteScape AI]]></wp:author_display_name>
        <wp:author_first_name><![CDATA[SiteScape]]></wp:author_first_name>
        <wp:author_last_name><![CDATA[AI]]></wp:author_last_name>
    </wp:author>
    
    <!-- Home Page -->
    <item>
        <title>${safeThemeName} - Home</title>
        <link>http://localhost/home/</link>
        <pubDate>${timestamp}</pubDate>
        <dc:creator><![CDATA[admin]]></dc:creator>
        <guid isPermaLink="false">http://localhost/?page_id=1</guid>
        <description></description>
        <content:encoded><![CDATA[
            <h1>Welcome to ${this.themeName}</h1>
            <p>This is your home page. You can edit this content using WordPress editor or Elementor.</p>
            <p>This theme was automatically generated by SiteScape AI.</p>
            
            <h2>Getting Started</h2>
            <ul>
                <li>Customize your site using Appearance → Customize</li>
                <li>Edit pages with Elementor page builder</li>
                <li>Add your own content and images</li>
                <li>Configure menus in Appearance → Menus</li>
            </ul>
        ]]></content:encoded>
        <excerpt:encoded><![CDATA[]]></excerpt:encoded>
        <wp:post_id>1</wp:post_id>
        <wp:post_date><![CDATA[${timestamp}]]></wp:post_date>
        <wp:post_date_gmt><![CDATA[${timestamp}]]></wp:post_date_gmt>
        <wp:post_modified><![CDATA[${timestamp}]]></wp:post_modified>
        <wp:post_modified_gmt><![CDATA[${timestamp}]]></wp:post_modified_gmt>
    ...
    <item>
        ...
        <link>http://localhost/about/</link>
        <pubDate>${timestamp}</pubDate>
        <dc:creator><![CDATA[admin]]></dc:creator>
        ...
        <content:encoded><![CDATA[
            <h1>About Us</h1>
            <p>Tell your story here. This is a sample about page that you can customize.</p>
        ]]></content:encoded>
        <excerpt:encoded><![CDATA[]]></excerpt:encoded>
    ...
    <item>
        <title>Contact</title>
        <link>http://localhost/contact/</link>
        <pubDate>${timestamp}</pubDate>
        <dc:creator><![CDATA[admin]]></dc:creator>
        ...
        <content:encoded><![CDATA[
            <h1>Contact Us</h1>
            <p>Get in touch with us. Add your contact form or information here.</p>
        ]]></content:encoded>
        <excerpt:encoded><![CDATA[]]></excerpt:encoded>
